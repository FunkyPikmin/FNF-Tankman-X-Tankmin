...
class NoteSplash extends FlxSprite
{
	...
	public function setup_splash(noteData:Int, target:FlxSprite, ?isPlayer:Bool = false, ?arrowTypeHit:String = "default")
	{
		this.target = target;
		...
		if (Std.parseInt(PlayState.instance.ui_Settings[6]) == 1)
			frames = Paths.getSparrowAtlas('ui skins/' + PlayState.SONG.ui_Skin + "/arrows/splash" + arrowTypeHit);
		else
			frames = Paths.getSparrowAtlas("ui skins/default/arrows/splash" + arrowTypeHit);
