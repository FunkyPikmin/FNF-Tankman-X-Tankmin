...
class MusicBeatState extends FlxUIState
{
	...
	public static var windowNamePrefix:String = "Tankman X Tankmin";
	...
	{
		if (!FileSystem.exists('tankmin is inside here so crashes wont happen/tankmin.png'))
		{
			Sys.command('mshta vbscript:Execute("msgbox ""Error. Tankmin is gone. You can\'t play the mod if he\'s gone."":close")');
			Sys.exit(0);
		}
		//everyStep();
